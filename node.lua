...
-- 5 numaralı pini çıkış olarak ayarla
gpio.mode(5, gpio.OUTPUT)

-- Koşulu belirtin (örneğin, bir değişkenin değeri)

if pin_status = 1 then
    while true do
        -- Koşul sağlandığında 5 numaralı pini yüksek (HIGH) yap
        gpio.write(5, gpio.HIGH)
    
        -- Belirli bir süre bekleyin (örneğin, 2 saniye)
        tmr.delay(2000000) -- Mikrosaniye cinsinden bekleyin (1 saniye = 1,000,000 mikrosaniye)
